...
date: "2024-12-31"
keywords: ["kuliah", "s2", "luar negeri","beasiswa", "tesis","disertasi","skripsi","perkapalan"]
tags: 
  - "indonesian"
...
{{<img caption="Contoh foto-foto kabel di dasar laut yang diambil oleh sebuah AUV."
source="[Real-time subsea communication cable detection for AUV-based inspection (2024)](https://eprints.soton.ac.uk/493608/)"
src="images/cable_images.jpg" >}}
...
{{<img caption="Metode deteksi kabel bawah laut menggunakan kamera. AUV membagi setiap gambar menjadi kotak 3x3. Model Computer Vision dapat mendeteksi keberadaan kabel di setiap kotak. Sebuah garis dapat ditarik melalui setiap kotak yang mengandung kabel untuk menentukan posisi dan orientasi kabel. Orientasi kabel digunakan untuk mengarahkan AUV untuk mengikuti bagian kabel selanjutnya."
source="[Real-time subsea communication cable detection for AUV-based inspection (2024)](https://eprints.soton.ac.uk/493608/)"
src="images/cable_detection.png" >}}
...
{{<img caption="Ilustrasi sistem pencarian kabel bawah laut dengan AUV. AUV mengetahui prediksi awal posisi kabel (Hijau) kemudian dapat memperbarui prediksi posisinya (Biru) berdasarkan posisi kabel terakhir yang terdeteksi (Merah)."
source="[Autonomous robotic monitoring of subsea communication cables (2024)](https://eprints.soton.ac.uk/491722/)"
src="images/cable_survey_udt2024.png" >}}
...
{{<img caption="Foto bersama Smarty200 AUV setelah pengujian di lab towing tank University of Southampton."
src="images/towing_tank.jpg" >}}
...
{{<img caption="Foto bersama poster disertasiku setelah selesai presentasi poster."
src="images/presentasi_poster.jpg" >}}
